...
const file_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x10proto/user.proto\x12\x04user\x1a\x1bgoogle/protobuf/empty.proto\"l\n" +
	...
	"\vUserService\x12F\n" +
	"\x0eGetUserByToken\x12\x16.google.protobuf.Empty\x1a\x1c.user.GetUserByTokenResponse\x12T\n" +
...
var file_proto_user_proto_goTypes = []any{
	(*GetUserByTokenResponse)(nil),    // 0: user.GetUserByTokenResponse
	(*UpdateUserBalanceRequest)(nil),  // 1: user.UpdateUserBalanceRequest
	(*UpdateUserBalanceResponse)(nil), // 2: user.UpdateUserBalanceResponse
	(*emptypb.Empty)(nil),             // 3: google.protobuf.Empty
}
var file_proto_user_proto_depIdxs = []int32{
	3, // 0: user.UserService.GetUserByToken:input_type -> google.protobuf.Empty
	1, // 1: user.UserService.UpdateUserBalance:input_type -> user.UpdateUserBalanceRequest
	0, // 2: user.UserService.GetUserByToken:output_type -> user.GetUserByTokenResponse
	2, // 3: user.UserService.UpdateUserBalance:output_type -> user.UpdateUserBalanceResponse
